...
void Employee::input()
{
	cout << "Please enter a name and gross pay; to quit, enter * followed by any number:" << endl;
	cin >> name >> grossPay;
} // input
...
void Employee::operator = (const Employee& otherEmployee)	//жиди=КХ
{
	name = otherEmployee.name;
	grossPay = otherEmployee.grossPay;
}
...
bool  Employee::operator > (const Employee& otherEmployee)	//жиди>КХ
{
	return grossPay > otherEmployee.grossPay;
}
